...
import {Modal, styles} from 'react-responsive-modal';
import Axios from 'axios';



class DisplayBookmarks extends React.Component {
    state = {
        posts: [],
        open: false,
    ...
    componentDidMount() {
        var retrivingData = "https://localhost:3001/article/bookmark";
        Axios.get(retrivingData).then(res => {
            this.setState({
